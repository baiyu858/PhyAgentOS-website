...
export const translations: Record<Lang, TranslationShape> = {
  en: {
    ...
    architecture: {
      ...
      trackA: 'Agent Layer',
      trackASub: 'Cognition Runtime',
      trackB: 'Execution Layer',
      trackBSub: 'Physical Runtime',
      protocol: 'Protocol',
      ...
      nodes: [
        ...
        { label: 'WatchdogSupervisor', sublabel: 'Supervisor', description: 'The execution-layer supervisor that watches the session queue, launches SessionRunners, and enforces lifecycle (pending→running→succeeded/failed).' },
